...
class FruitsControllerTest < ActionController::TestCase
  ...
  test "should create fruit" do
    assert_difference('Fruit.count') do
      post :create, fruit: { description: @fruit.description, name: @fruit.name, picture: @fruit.picture }
    end
  ...
  test "should update fruit" do
    patch :update, id: @fruit, fruit: { description: @fruit.description, name: @fruit.name, picture: @fruit.picture }
    assert_redirected_to fruit_path(assigns(:fruit))
  end
